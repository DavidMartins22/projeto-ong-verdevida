...
function initCarrossel() {
    ...
    carrosseis.forEach(container => {
        const images = container.querySelectorAll(".carrossel-container .carrossel-img");
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 🌗 ---- MODO ESCURO / CLARO (COM SALVAMENTO NO LOCALSTORAGE) ----
    ...
    if (btn) {
        ...
        if (savedTheme === "dark") {
            ...
            btn.textContent = "☀️"; // ícone sol para voltar ao claro
        } else {
            btn.textContent = "🌙"; // ícone lua para ativar o escuro
        }

        // Quando clicar, alterna o tema e salva no localStorage
